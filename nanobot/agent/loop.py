...
class AgentLoop:
    ...
    def __init__(
        ...
        _mem_provider = (
            provider.memory_provider if isinstance(provider, _FallbackProvider) else provider
        )
        _mem_model = (
            provider.memory_model if isinstance(provider, _FallbackProvider) else self.model
        )
